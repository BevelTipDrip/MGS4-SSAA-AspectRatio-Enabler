...
- Lab build: frame-pacing instrumentation and experiments (vblank wait log, hitch sampler, frame-skip governor switch and more; see docs/pw/frame-pacing.md). The once-a-second doubled frame at 60 Hz in Borderless and Fullscreen is the game's own frame-skip governor; the Lab switch removes it.
